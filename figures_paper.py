...
def table_individual():
    ...
    print len(pairs[select])

    for ic,vc in enumerate(pairs[select]):

        import scipy.special
        sigmas=scipy.special.erfinv(1.-vc['MLRT1'])*np.sqrt(2.)
        print 'ic=%03d ra_1=% 10.5f dec_1=% 10.5f ra_2=% 10.5f dec_2=% 10.5f z_1=%2.4f z_2=%2.4f MLRT1=%10.4f sigmas=%2.2f BF1=%10.2f BF2=%10.2f R_pair=%10.f M_1=%2.2f M_2=%2.2f ' % (
                    vc['ipair'],
                    vc['ra1'],
                    vc['dec1'],
                    vc['ra2'],
...
def main():
    ...
    valid_actions = ['figure_fields','figure_model','figure_contours','table_individual']
