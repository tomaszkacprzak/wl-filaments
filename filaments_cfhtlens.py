...
def select_halos_graph(range_z=[0.1,0.6],range_M=[2,10],filename_halos='LRG_cfhtlens.fits',apply_graph=True):
...
def main():
    ...
    select_halos_graph(filename_halos=filename_halos,range_M=range_M,range_z=range_z)
