...
def get_best_neighbour(pairs,halo1,halo2):
    ...
    # select_cut = ( (halo1['m200_fit'] > 1e13) & (halo2['m200_fit'] > 1e13) & (Dtot < 13) & (Dtot > 5) & (pairs['Dlos'] > 0) & (pairs['Dxy'] > 4) & ((halo1['m200_sig'] > 1.9) | (halo2['m200_sig'] > 1.9)) ) # 010-lrgs-topo 2.05 37
